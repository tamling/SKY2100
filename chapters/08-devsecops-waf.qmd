...
\end{tikzpicture}
-->
*[Diagram — eight stages (Plan, Code, Build, Test, Release, Deploy, Operate, Monitor) arranged in a circle with clockwise arrows forming a continuous loop; a circle labelled "Security at every stage" sits at the centre, with "SAST" marked beside the Build stage and "DAST" beside the Test stage.]*

The DevSecOps loop. Development (plan, code, build, test) flows

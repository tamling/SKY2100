...
\end{tikzpicture}
-->
*[Diagram — four boxes arranged in a circle (Preparation, Detection & Analysis, Containment/Eradication & Recovery, Post-Incident Analysis) with arrows leading from each to the next and from Post-Incident Analysis back to Preparation, forming a loop.]*

The NIST incident response lifecycle. A cycle rather than a line:

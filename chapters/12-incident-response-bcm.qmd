...
::: {#exr-12-sort-event-incident-breach}
...
::: {#exr-12-grc-pairs}
## The GRC toolbox, interactive
@sec-12-risk-audit-compliance names the non-technical tools of governance,
risk and compliance, and Comer adds the risks a register exists to record.
Match each term to its description: click a term and then its description
(or drag the term onto it) - a correct pair locks and greys out, a wrong
attempt flashes red. Press **Check** to see how many pairs you have.

{{< include _12-grc-pairs.qmd >}}
:::

::: {#exr-12-rto-rpo-tf}
## Continuity targets: true or false?, interactive
@sec-12-business-continuity sets the two targets that quantify business
continuity. Mark each statement below **True** or **False**, then press
**Check** - each statement is judged on its own.

{{< include _12-rto-rpo-tf.qmd >}}
:::

::: {#exr-12-regulatory-frame}
## The European regulatory frame, interactive
For a Norwegian institution the regulatory frame is European
(@sec-12-risk-audit-compliance). Place the right instrument on each
description: drag a name onto a box, or click the name and then the box,
then press **Check**. Two of the five names belong to none of the boxes.

{{< include _12-regulatory-frame.qmd >}}
:::

::: {.callout-important icon=false}
## Related lab: hands-on for this session
Theory done - now build it. This session's practical task is
[Exercise 12: Automate a control - and govern with NIST CSF 2.0](../labs/exercise-12.qmd)
(90-120 min, in your lab group); its risk-register, assurance and
governance parts put this chapter's GRC concepts to work. The
incident-response lifecycle itself - containment and the incident
report - is walked through hands-on in
[Exercise 10](../labs/exercise-10.qmd). Work from the official worksheet PDF in

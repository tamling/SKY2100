...
\end{tikzpicture}
-->
*[Diagram — a triangle with "information" at its centre and one labelled box at each corner: Confidentiality (disclosed only to the authorised), Integrity (not altered undetectably) and Availability (reachable when needed).]*

The CIA triad. Every control in this course protects at least one of

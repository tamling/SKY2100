...
\end{tikzpicture}
-->
*[Diagram — two side-by-side panels. Left ("IDS — detection"): traffic flows directly to the service while a dashed line taps a copy down to an IDS box labelled "alert only". Right ("IPS — prevention"): traffic passes through an IPS box sitting inline before reaching the service, labelled "blocks in line".]*

IDS versus IPS. An IDS observes a copy of the traffic and alerts; an

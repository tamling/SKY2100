...
\end{tikzpicture}
-->
*[Diagram — a data-centre box containing two servers: a "north–south" arrow connects the Internet (clients) to the data centre, and an "east–west" arrow connects the two servers inside it.]*

Two directions of traffic. North–south crosses the data-centre
...
**[Chapter 02 self-check quiz](CANVAS-QUIZ-URL-PLACEHOLDER)** *(link added
